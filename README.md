...
Although EatCode is open-source, EatCode does have a license, protecting against its copyright. Under __*no circumstances*__ do we allow unlawful reproduction or distribution of EatCode for the purpose of commerical gains. Please refer the ["license.md"](https://github.com/eatcode-gt/eatcodeweb/blob/main/license.md) for more information.
